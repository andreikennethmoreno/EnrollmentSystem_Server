...
describe('DepartmentHead Routes', () => {
  ...
  it('should create a new department head with password', async () => {
    ...
    expect(res.body.data).toHaveProperty('head_id');
    createdDepartmentHeadId = res.body.data.head_id;
  ...
  it('should validate that password is hashed correctly', async () => {
    ...
    const res = await query('SELECT password FROM department_heads WHERE head_id = $1', [createdDepartmentHeadId]);
  ...
  it('should get all department heads', async () => {
    ...
    expect(res.body.data[0]).toHaveProperty('head_id');
  ...
  it('should get a department head by ID', async () => {
    ...
    expect(res.status).toBe(200);
    expect(res.body.data.head_id).toBe(createdDepartmentHeadId);
  });
  ...
  it('should delete a department head by ID', async () => {
    ...
    expect(res.status).toBe(200);
    expect(res.body.data).toHaveProperty('head_id', createdDepartmentHeadId);
  });
  ...
  afterAll(async () => {
    ...
    await query('DELETE FROM department_heads WHERE head_id = $1', [createdDepartmentHeadId]);
